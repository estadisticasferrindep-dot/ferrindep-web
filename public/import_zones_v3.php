<?php
// DB Zone Importer V3 - Cache Bypass Edition
...
// DEBUG CONFIRMED: /home/ferrinde/ferrindep EXISTS.
...
echo "🚀 INICIANDO IMPORTACION DE ZONAS (V3 - FINAL)\n";
echo "=======================================\n\n";
...
foreach ($zonesToImport as $item) {
    ...
    try {
        ...
        if ($existing) {
            ...
            // 2. Create Destino
            echo "➕ CREANDO: '$name' ... ";
            // FIX for SQL Error 1364: Include zona_id in creation
            $newDestino = Destino::create([
                'nombre' => $name,
                'zona_id' => $zonaId // Mandatory field
            ]);
