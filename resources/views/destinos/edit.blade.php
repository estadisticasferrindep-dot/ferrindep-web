            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('destinos.update',$destino)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label>Nombre</label>
                                    <input type="text" name="nombre" value="{{old('nombre', $destino->nombre)}}" class="form-control" placeholder="Nombre">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="zona_id">
                                        ...
                                        @foreach ($zonas as $zona)
                                            <option {{ old('zona_id', $destino->zona_id) == $zona->id ? 'selected' : '' }} value="{{$zona->id}}"> {{$zona->nombre}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
