            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('galerias.update', $galeria)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label>Nombre</label>
                                        <input type="text" name="nombre" value="{{old('nombre', $galeria->nombre)}}" class="form-control" placeholder="Nombre">
                                    </div>
                                </div>
