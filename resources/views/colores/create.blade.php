            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('colores.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Nombre</label>
                                    <input type="text" name="nombre" value="{{old('nombre')}}" class="form-control" placeholder="Descripción">
                                </div>
                            </div>
