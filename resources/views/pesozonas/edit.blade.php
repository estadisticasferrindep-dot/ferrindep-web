            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('pesozonas.update',$pesozona)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <label>Peso</label>
                                    <input step=".01" type="number" name="peso" value="{{ old('peso', $pesozona->peso) }}" class="form-control">
                                </div> 
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="zona_id">
                                        ...
                                        @foreach ($zonas as $zona)
                                            <option {{ old('zona_id', $pesozona->zona_id) == $zona->id ? 'selected' : '' }} value="{{$zona->id}}"> {{$zona->nombre}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <label>Precio</label>
                                    <input step=".01" type="number" name="costo" value="{{ old('costo', $pesozona->costo) }}" class="form-control">
                                </div> 
                            </div>
                            <br>
