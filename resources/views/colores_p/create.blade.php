            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('coloresP.store', $producto)}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="color_id">
                                    ...
                                    @foreach ($colores as $color)
                                        <option {{ old('color_id') == $color->id ? 'selected' : '' }} value="{{$color->id}}"> {{$color->nombre}}</option>
                                    @endforeach
                                </select>
                            </div>
