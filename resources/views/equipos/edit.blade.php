                    ...
                    @endif
                        ...
                        <form action="{{route('equipos.update',$equipo)}}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" {{ old('show',$equipo->show) == 1 ? 'checked' : '' }} name="show" value="1">
                                <label class="form-check-label">Mostrar</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" {{ old('en_venta',$equipo->en_venta) == 1 ? 'checked' : '' }} name="en_venta" value="1">
                                <label class="form-check-label">En venta</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" {{ old('en_alquiler',$equipo->en_alquiler) == 1 ? 'checked' : '' }} name="en_alquiler" value="1">
                            ...
                            <div class="form-group ">
                                ...
                                <textarea class="form-control summernote" name="tabla"  rows="3">{{old('tabla',$equipo->tabla)}}</textarea>
                            </div>
