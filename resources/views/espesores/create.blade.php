            ...
            <div class="card" style="margin-top:15px;">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{route('espesores.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf

                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label>Espesor</label>
                                    <input type="text" name="espesor" value="{{old('espesor')}}" class="form-control" placeholder="Espesor">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                    <label>Orden</label>
